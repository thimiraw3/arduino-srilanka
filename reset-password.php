...
<head>
    ...
    <title>Reset Password | Arduino Sri-Lanka</title>
                ...
                <div class="row card opacity-75 rounded-5">
                    <div class="card-body">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input id="pw" class="form-control rounded-5" type="password" />
                        </div>

                        <div class="col-12 mb-3">
                            <label class="form-label" for="">Confirm New Password</label>
                            <input id="cpw" class="form-control rounded-5" type="password" />
                        </div>
                        ...
                        <div class="d-grid mb-3">
                            <button class="btn btn-secondary rounded-5" onclick="resetPassword();">Reset Password</button>
                        </div>
