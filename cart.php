...
?>
    ...
    <head>
        ...
        <title>Cart | Arduino Sri-Lanka</title>
    ...
    <body onload="loadCartProcess();" class="overflow-x-hidden">
        ...
        <div class="container">
            ...
            <div class="col-12 mb-3">
                <span class="fs-1">Cart &nbsp; <i class="bi bi-cart-fill text-dark fs-2"></i> </span>
            </div>
